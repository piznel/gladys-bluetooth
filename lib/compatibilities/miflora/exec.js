        ...
        return rp(options)
            .then((parsedResult) => {
                parsedResult.types.forEach(function(type) {
                    switch (type.type) {
                        case 'temperature':
                            if ((now - lastMeasureDate) >= mesureDelayTemperature) {
                            ...
                            break;
                        case 'lux':
                            if ((now - lastMeasureDate) >= mesureDelayLux) {
                            ...
                            break;
                        case 'moisture':
                            if ((now - lastMeasureDate) >= mesureDelayMoisture) {
                            ...
                            break;
                        case 'fertility':
                            if ((now - lastMeasureDate) >= mesureDelayFertility) {
        ...
        return rp(options)
            .then((parsedResult) => {
                parsedResult.types.forEach(function(type) {
                    switch (type.type) {
                        case 'batteryLevel':
                            if ((now - lastMeasureDate) >= mesureDelayBatteryLevel) {
